...
Due Date: [To be set by instructor] Points: 20 total Estimated Time: 3-4 hours
...
Git Version Control: Branching, committing, merging, and collaboration workflows
Command Line Interface: Shell scripting, file operations, and automation
Python Programming: Functions, file I/O, data processing, and modular design
Requirements
...
Create a new repository named datasci-week02-integration (separate from this assignment folder)
Set up the following branch structure:
...
Create setup_project.sh from scratch with the following functionality:
...
Test the script and verify all files are created
Commit the script to the feature/project-scaffold branch
Script Requirements:
...
Expected Output Structure: After running your script, the following files and directories should exist:
...
Create and complete src/data_analysis.py with basic functionality
Create and complete src/data_analysis_functions.py with modular design
Ensure both scripts output results to output/analysis_report.txt
...
Expected Output Format: Both scripts should create output/analysis_report.txt with:
...
Repository Structure: Your repository must have the exact structure shown in the documentation
Git History: At least 3 commits per branch with meaningful commit messages
Working Scripts: Both Python scripts must run without errors
Output Files: output/analysis_report.txt must be generated by both scripts
Documentation: Professional README.md with project overview and usage instructions
Grading Rubric
...
Git Issues: Don't forget to commit and push your changes
File Paths: Ensure all file paths are correct and relative
Python Errors: Test your scripts before submitting
Documentation: Make sure your README.md is comprehensive and professional
Getting Help
